...
hl.config({
    general = {
        ...
        col = {
            -- PRIMARY → SECONDARY градиент на активном окне
            active_border   = { colors = {"rgba(7aa2f7ee)", "rgba(bb9af7ee)"}, angle = 45 },
            -- BORDER — неактивные рамки
...
hl.config({
    ...
    cursor = {
        no_hardware_cursors = false, -- Включает аппаратный курсор (убирает лаги мыши)
    },
})
...
-- Super + Shift + Print -> весь монитор
...
hl.window_rule({
    name  = "telegram-workspace-2",
    match = { class = "org.telegram.desktop" },
    workspace = "2",
})

-- Включаем блюр для уведомлений (ловим и notifications, и dunst)
hl.layer_rule({
    name  = "dunst-blur",
    match = { namespace = "^(notifications|dunst)$" },
    blur  = true,
})
